...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case './translations/uk.json': return Promise.resolve().then(function () { return require('./uk-DAfwTpcY.js'); });
    ...
    register (app) {
        ...
        if (backendURL?.includes('localhost')) {
            app.addMenuLink({
                ...
                Component: async ()=>{
                    const { App } = await Promise.resolve().then(function () { return require('./App-gqL5Al7X.js'); });
                    return App;
                }
            });
            const plugin = {
...
//# sourceMappingURL=index-DBXv-hIg.js.map
