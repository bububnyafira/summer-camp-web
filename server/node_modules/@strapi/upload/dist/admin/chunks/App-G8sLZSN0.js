...
var index = require('./index-DDQjAhM2.js');
require('byte-size');
require('date-fns');
var qs = require('qs');
...
// TODO: find a better naming convention for the file that was an index file before
const ConfigureTheView = /*#__PURE__*/ React__namespace.lazy(async ()=>Promise.resolve().then(function () { return require('./ConfigureTheView-D9XLMDtA.js'); }).then((mod)=>({
...
//# sourceMappingURL=App-G8sLZSN0.js.map
