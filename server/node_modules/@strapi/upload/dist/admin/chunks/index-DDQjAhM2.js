...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./App-G8sLZSN0.js'); }).then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await Promise.resolve().then(function () { return require('./SettingsPage-DcdF16oj.js'); });
                return {
...
//# sourceMappingURL=index-DDQjAhM2.js.map
