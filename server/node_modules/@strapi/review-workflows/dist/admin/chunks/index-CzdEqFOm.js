...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case './translations/en.json': return Promise.resolve().then(function () { return require('./en-BNGiWajd.js'); });
    ...
    register (app) {
        if (window.strapi.features.isEnabled(FEATURE_ID)) {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { Router } = await Promise.resolve().then(function () { return require('./router-ChVwf8TN.js'); });
                    return {
                        default: Router
                    };
                }
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseReviewWorkflows } = await Promise.resolve().then(function () { return require('./purchase-review-workflows-BDLncDcz.js'); });
                    return {
...
//# sourceMappingURL=index-CzdEqFOm.js.map
