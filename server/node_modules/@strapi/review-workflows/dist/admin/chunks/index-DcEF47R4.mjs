    ...
    register (app) {
        if (window.strapi.features.isEnabled(FEATURE_ID)) {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { Router } = await import('./router-D-YCUzYy.mjs');
                    return {
                        default: Router
                    };
                }
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseReviewWorkflows } = await import('./purchase-review-workflows-4n0KXAeo.mjs');
                    return {
...
//# sourceMappingURL=index-DcEF47R4.mjs.map
