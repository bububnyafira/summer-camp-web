     ...
     */ app.createHook('ContentReleases/pages/ReleaseDetails/add-locale-in-releases');
        if (window.strapi.features.isEnabled('cms-content-releases')) {
            app.addMenuLink({
                ...
                Component: ()=>Promise.resolve().then(function () { return require('./App-CJiqPP7-.js'); }).then((mod)=>({
                            default: mod.App
                        })),
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { ProtectedReleasesSettingsPage } = await Promise.resolve().then(function () { return require('./ReleasesSettingsPage-KRcoI1bC.js'); });
                    return {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseContentReleases } = await Promise.resolve().then(function () { return require('./PurchaseContentReleases-Z9uEPb5b.js'); });
                    return {
...
//# sourceMappingURL=index-vjWrvGN3.js.map
