     ...
     */ app.createHook('ContentReleases/pages/ReleaseDetails/add-locale-in-releases');
        if (window.strapi.features.isEnabled('cms-content-releases')) {
            app.addMenuLink({
                ...
                Component: ()=>import('./App-BkWgp5q_.mjs').then((mod)=>({
                            default: mod.App
                        })),
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { ProtectedReleasesSettingsPage } = await import('./ReleasesSettingsPage-DUKdFdvx.mjs');
                    return {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseContentReleases } = await import('./PurchaseContentReleases-CzayeVUD.mjs');
                    return {
...
//# sourceMappingURL=index-DBUaMD56.mjs.map
