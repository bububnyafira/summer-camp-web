 ...
 * -----------------------------------------------------------------------------------------------*/ const ApplicationInfoPage = ()=>{
    ...
    const AdminSeatInfo = useEnterprise.useEnterprise(AdminSeatInfoCE, async ()=>(await Promise.resolve().then(function () { return require('./AdminSeatInfo-DmnYrObU.js'); })).AdminSeatInfoEE);
...
//# sourceMappingURL=ApplicationInfoPage-OOwLqiOb.js.map
