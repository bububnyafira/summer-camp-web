...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-Db8NBG_s.mjs';
import { a as useAuth, p as useAppInfo, q as useStrapiApp, d as useTracking, P as Page } from './Theme-V3hA9wVU.mjs';
...
const useSettingsMenu = ()=>{
   ...
   */ const ceLinks = React.useMemo(()=>SETTINGS_LINKS_CE(), []);
    const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async ()=>(await import('./index-Db8NBG_s.mjs').then(function (n) { return n.O; })).SETTINGS_LINKS_EE(), {
...
export { Layout };
//# sourceMappingURL=Layout-B6VGEUHf.mjs.map
