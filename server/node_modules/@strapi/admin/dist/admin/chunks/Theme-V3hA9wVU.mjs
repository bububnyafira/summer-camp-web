...
import { s as setCookie, e as deleteCookie, g as getCookieValue, a as adminApi, f as useInitQuery, h as useTelemetryPropertiesQuery, j as useProjectSettingsQuery, k as useUpdateProjectSettingsMutation } from './admin-DcWCrquO.mjs';
...
const getStoredToken = ()=>{
    const fromLocalStorage = localStorage.getItem(STORAGE_KEYS$1.TOKEN);
    if (fromLocalStorage) {
        return JSON.parse(fromLocalStorage);
    }
    const fromCookie = getCookieValue(STORAGE_KEYS$1.TOKEN);
...
//# sourceMappingURL=Theme-V3hA9wVU.mjs.map
