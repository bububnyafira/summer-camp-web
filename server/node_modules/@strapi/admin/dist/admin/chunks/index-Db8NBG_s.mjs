...
import { i as isBaseQueryError, f as useInitQuery, a as adminApi, l as createAbsoluteUrl, m as getFetchClient } from './admin-DcWCrquO.mjs';
 ...
 */ const getEERoutes$1 = ()=>window.strapi.isEE ? [
        {
            ...
            lazy: async ()=>{
                const { AuthResponse } = await import('./AuthResponse-DpLHevlc.mjs');
                return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await import('./ListPage-BdXel3DW.mjs');
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await import('./SingleSignOnPage-CwhSZkNY.mjs');
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise(Login, async ()=>(await import('./Login-DdGmQr76.mjs')).LoginEE);
    const forms = useEnterprise(FORMS, async ()=>(await import('./constants-BM9IA74M.mjs')).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-DLbf1RfA.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-Chno-nW0.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-f6ArIkfR.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-BLw3dr0Z.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-DhUsP74s.mjs');
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-D5H4npKA.mjs');
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const editWebhook = await import('./EditPage-CWF1UAmY.mjs').then(function (n) { return n.b; });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-DWRGgPOK.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-BuHzbNwJ.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-CAR8KhKN.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditViewPage-Cbykk3zj.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-BWYAhzT_.mjs');
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-BKnfHYWJ.mjs');
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditView-DXqe8iMF.mjs');
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-QF9n9peX.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-1u9mpHpi.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-B-4xYXkQ.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await import('./PurchaseContentHistory-GnDmXlJ8.mjs');
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await import('./UseCasePage-CBE1VZ-n.mjs');
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await import('./HomePage-CVGPracE.mjs');
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await import('./ProfilePage-C9LyGkdC.mjs');
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await import('./MarketplacePage-BJY7yER9.mjs');
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await import('./Layout-B6VGEUHf.mjs');
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await import('./ApplicationInfoPage-qd_lnJFO.mjs');
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await import('./AuthenticatedLayout-BOvKyniy.mjs');
                            return {
...
//# sourceMappingURL=index-Db8NBG_s.mjs.map
