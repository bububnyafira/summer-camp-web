...
const useSettingsMenu = ()=>{
   ...
   */ const ceLinks = React__namespace.useMemo(()=>index.SETTINGS_LINKS_CE(), []);
    const { admin: adminLinks, global: globalLinks } = useEnterprise.useEnterprise(ceLinks, async ()=>(await Promise.resolve().then(function () { return require('./index-94ms2ZT7.js'); }).then(function (n) { return n.constants; })).SETTINGS_LINKS_EE(), {
...
//# sourceMappingURL=Layout-BZ9-NERa.js.map
