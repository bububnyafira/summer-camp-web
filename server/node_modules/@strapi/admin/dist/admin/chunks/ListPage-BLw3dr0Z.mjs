...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-Db8NBG_s.mjs';
import { b as useNotification, e as useAPIErrorHandler, c as useTypedSelector, P as Page, k as useRBAC } from './Theme-V3hA9wVU.mjs';
import { u as useEnterprise } from './useEnterprise-Dy8wMNV5.mjs';
import { g as getDisplayName } from './users-B3iOAYG-.mjs';
import * as yup from 'yup';
import { i as isBaseQueryError } from './admin-DcWCrquO.mjs';
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-BPggX3FY.mjs';
...
import './useAdminRoles-CiA81yrO.mjs';
...
const ModalForm = ({ onToggle })=>{
    ...
    const MagicLink = useEnterprise(MagicLinkCE, async ()=>(await import('./MagicLinkEE-yA4pDBwQ.mjs')).MagicLinkEE);
 ...
 * -----------------------------------------------------------------------------------------------*/ const ListPageCE = ()=>{
    ...
    const CreateAction = useEnterprise(CreateActionCE, async ()=>(await import('./CreateActionEE-C7k2pZ5x.mjs')).CreateActionEE);
...
const ListPage = ()=>{
    const UsersListPage = useEnterprise(ListPageCE, async ()=>// eslint-disable-next-line import/no-cycle
        (await import('./ListPage-pnVrt1Ll.mjs')).UserListPageEE);
    // block rendering until the EE component is fully loaded
    if (!UsersListPage) {
        return null;
    }
...
//# sourceMappingURL=ListPage-BLw3dr0Z.mjs.map
