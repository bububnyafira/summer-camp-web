...
const RelationSingle = ({ mainField, content })=>{
    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Typography, {
        ...
        textColor: "neutral800",
        ellipsis: true,
        children: usePrev.getRelationLabel(content, mainField)
    });
};
/**
 ...
 */ const RelationMultiple = ({ mainField, content, rowId, name })=>{
    ...
    const { data, isLoading } = usePrev.useGetRelationsQuery({
        model,
        id: rowId,
        targetField
    }, {
                        ...
                        children: [
                            data.results.map((entry)=>/*#__PURE__*/ jsxRuntime.jsx(designSystem.Menu.Item, {
                                    ...
                                    children: /*#__PURE__*/ jsxRuntime.jsx(designSystem.Typography, {
                                        maxWidth: "50rem",
                                        ellipsis: true,
                                        children: usePrev.getRelationLabel(entry, mainField)
                                    })
                                }, entry.documentId)),
...
//# sourceMappingURL=ListViewPage-BfFRaMK8.js.map
