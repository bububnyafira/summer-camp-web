...
const DraggableCard = ({ attribute, index: index$1, isDraggingSibling, label, name, onMoveField, onRemoveField, setIsDraggingSibling })=>{
    ...
    const [{ isDragging }, objectRef, dropRef, dragRef, dragPreviewRef] = objects.useDragAndDrop(true, {
        type: objects.ItemTypes.FIELD,
        item: {
            index: index$1,
            label,
            name
...
//# sourceMappingURL=ListConfigurationPage-BiKI9-fH.js.map
