...
var Input = require('./Input-D3aI7eJe.js');
var qs = require('qs');
var EditViewPage = require('./EditViewPage-Cd7iCrfo.js');
 ...
 * -----------------------------------------------------------------------------------------------*/ const PreviewHeader = ()=>{
    ...
    const onPreview = index.useDocumentContext('PreviewHeader', (state)=>state.onPreview);
    const [{ query }] = strapiAdmin.useQueryParams();
    const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=Preview-BvCbqXQY.js.map
